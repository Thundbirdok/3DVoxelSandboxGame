...
public partial class VoronoiDiagram
{
    ...
    // constructor
    public VoronoiDiagram(double minDistanceBetweenSites)
    {
        siteidx = 0;
        sites = null;
     ...
     * @return
     */
    public List<GraphEdge> GenerateDiagram(double[] xValuesIn, double[] yValuesIn, double minX, double maxX, double minY, double maxY)
    {
